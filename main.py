...
parser.add_argument('--model-type', default='all', choices=['all', 'conv3D_MFCCs', 'conv2D_MF', 'audio_MF'])
parser.add_argument('--conv2d-load-path', default='')
parser.add_argument('--conv3d-load-path', default='')
parser.add_argument('--audio-load-path', default='')
...
elif args.model_type == 'audio_MF':
    runner = EnsembleModelRunner(load_paths=[args.audio_load_path], model_type=args.model_type)
